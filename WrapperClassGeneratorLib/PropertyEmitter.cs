namespace DRMWrapperClassGenLib
{
    ...
    public class PropertyEmitter
    {
        private static readonly MethodInfo ProxBaseGetVal =
            typeof(TypeSafePropBagBase).GetTypeInfo().DeclaredMethods.Single(m => m.Name == "GetItWithNoType");

        private static readonly MethodInfo ProxBaseSetVal =
            typeof(TypeSafePropBagBase).GetTypeInfo().DeclaredMethods.Single(m => m.Name == "SetItWithType");

        private static readonly MethodInfo ProxBaseSetValNT =
            typeof(TypeSafePropBagBase).GetTypeInfo().DeclaredMethods.Single(m => m.Name == "SetItWithNoType");
